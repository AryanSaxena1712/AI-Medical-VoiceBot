#1 : Setup Audio recorder (ffmpeg and portaudio)
import logging
import os
...
def record_audio(file_path,timeout=20,phrase_time_limit=None):
    """
    Simplified funtion to record audio from the mocrophone and save it as an MP3 file,

    Args:
    file_path (str): Path to save the recorded audio file.
    timeout (int): Maximum time to wait for a phrase to start (in second).
...
stt_model = "whisper-large-v3" #Stt model
